...
list1=[2,7,4,1,3,6]
print("counting pairs of elements with sum equal to 10:",countPairs(list1))
...
print(matrixPower(matrixa,m))

s= input("enter the string: ")
char,count=countCharacters(s)
print(f"the maximum number of occurences of a character in the string is {countCharacters(s)}")
